...
function Metric({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-edge/75 bg-[#0a0f1d]/90 px-4 py-4 shadow-[0_16px_45px_rgba(0,0,0,0.2)] transition duration-200 hover:-translate-y-0.5 hover:border-edge-strong">
      ...
      <p className="mt-2 text-2xl font-semibold tracking-[-0.03em] text-ink-primary">
        {value}
      </p>
    ...
    >
      <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-5 sm:gap-6">
        <section className="relative overflow-hidden rounded-[24px] border border-edge/80 bg-[#090e1b] shadow-[0_30px_90px_rgba(0,0,0,0.34)]">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_12%_0%,rgba(112,55,221,0.25),transparent_34%),radial-gradient(circle_at_80%_8%,rgba(201,169,97,0.10),transparent_27%),linear-gradient(135deg,rgba(255,255,255,0.018),transparent_44%)]"
          />
          <div className="relative flex flex-col gap-6 px-5 py-6 sm:px-7 sm:py-7 lg:flex-row lg:items-end lg:justify-between lg:px-8">
            <div className="max-w-3xl">
              ...
              <h2 className="text-3xl font-semibold tracking-[-0.035em] text-ink-primary sm:text-4xl lg:text-[42px]">
                Turn verified source material into polished spoken content
              </h2>
            ...
            <div className="flex flex-wrap gap-2.5">
              <Link
                ...
                className="rounded-xl border border-edge-strong bg-white/[0.025] px-4 py-2.5 text-sm font-medium text-ink-primary transition hover:bg-white/[0.055] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-highlight"
              >
                Scripture Studio
              </Link>
              <Link
                href="/dashboard/captions"
                className="rounded-xl bg-gradient-to-r from-[#6931d6] to-[#7d39e6] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(103,46,214,0.28)] transition hover:brightness-110 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-highlight"
              >
                Caption Studio
              </Link>
            </div>
            ...
            <EmptyState
              ...
              action={
                <Link
                  ...
                  className="rounded-xl bg-gradient-to-r from-[#6931d6] to-[#7d39e6] px-4 py-2 text-sm font-semibold text-white transition hover:brightness-110 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-highlight"
                >
                  Create Content
                </Link>
              }
            ...
            <div className="flex min-w-0 flex-col gap-6">
              ...
              >
                <div className="mb-4 flex items-start gap-2.5 rounded-xl border border-[#7138dc]/20 bg-[#7138dc]/[0.055] px-4 py-3">
                  <Sparkles
                    aria-hidden="true"
                    className="mt-0.5 size-4 shrink-0 text-[#bda7ff]"
                  />
                  <p className="text-xs leading-5 text-ink-secondary">
              ...
              >
                {revisions.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-edge px-4 py-6 text-sm text-ink-muted">
                  ...
                  <ol className="flex flex-col gap-3">
                    {revisions.map((revision) => (
                      <li
                        key={revision.id}
                        className="rounded-xl border border-edge/70 bg-[#0b1120]/70 px-3.5 py-3"
                      >
                        <details>
            ...
            <aside className="flex min-w-0 flex-col gap-6 2xl:sticky 2xl:top-24">
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Link
                    href="/dashboard/scripture"
                    className="rounded-xl border border-edge-strong px-3.5 py-2 text-xs font-medium text-ink-primary transition hover:bg-white/[0.05] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-highlight"
                  >
                    Review Scripture
                  </Link>
                  <Link
              ...
              <section className="rounded-2xl border border-edge/80 bg-[#0a0f1d]/75 px-4 py-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-ink-muted">
                      A saved revision proves only that script prose was saved.
                      It is not approval, scheduling or publication. AI drafts
                      remain drafts until accepted through the normal revision
                      path, and Scripture remains structurally separate from
                      every script field.
                    </p>
                  </div>
                </div>
