  ...
  return (
    <DashboardShell title="Growth Centre" pathname="/dashboard/growth" email={user.email ?? null}>
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        ...
        <SectionCard title="Repurpose opportunities" description="Evidence-informed planning suggestions only. Nothing here creates a variant, schedules a post, changes approval or publishes content.">
