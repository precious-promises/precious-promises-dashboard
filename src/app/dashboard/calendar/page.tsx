...
export default async function CalendarPage(
  ...
  const todayEntries = allEntries.filter(
    (entry) =>
      ...
      isoDateInTimeZone(new Date(entry.post.scheduled_for), timeZone) === todayKey,
  );
          ...
          <div className="relative flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-ink-secondary sm:text-base">
                ...
                rhythm and manage upcoming slots from one place. Times display in
                {` ${timeZone}`}; schedule records do not claim a post was published.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                <ShieldCheck aria-hidden="true" className="size-4 text-highlight" />
                Review approvals
              </Link>
              <a
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <metric.icon aria-hidden="true" className="size-4 text-highlight" />
                </div>
                <p className="mt-2 text-2xl font-semibold text-ink-primary">
                  {metric.value}
                </p>
                <p className="mt-0.5 text-[11px] text-ink-muted">{metric.detail}</p>
              </div>
            ))}
          </div>
        </section>
            ...
            >
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div className="rounded-xl border border-edge/70 bg-panel-raised/30 p-3">
                  ...
                  <p className="mt-1 text-xl font-semibold text-gold">{pausedCount}</p>
                </div>
                <div className="rounded-xl border border-edge/70 bg-panel-raised/30 p-3">
                  <p className="text-[10px] font-semibold tracking-wide text-ink-muted uppercase">
                    Cancelled
